...
const I18N = {
    ...
    translations: {
        "zh-CN": {
            ...
            "highlight.4.desc": "泰语原文单词之间没有空格，新手根本不知道在哪里断词。ThaiFlow 自动在词与词之间加上空格，字幕结构一眼看懂，跟读定位更轻松。",
        ...
        "zh-TW": {
            ...
            "highlight.4.desc": "泰語原文單詞之間沒有空格，新手根本不知道在哪裡斷詞。ThaiFlow 自動在詞與詞之間加上空格，字幕結構一眼看懂，跟讀定位更輕鬆。",
            "highlight.4.before": "原始",
        ...
        "en": {
            ...
            "highlight.4.desc": "Thai text has no spaces between words, so beginners can't tell where one word ends. ThaiFlow automatically inserts spaces between words — subtitles become instantly readable.",
        ...
        "ja": {
            ...
            "highlight.4.desc": "タイ語は単語間にスペースがなく、初心者にはどこで区切るか分かりません。ThaiFlowは自動的に単語間へスペースを挿入。字幕の構造が一目で分かります。",
        ...
        "ko": {
            ...
            "highlight.4.desc": "태국어 원문은 단어 사이에 공백이 없어 초보자는 어디서 끊어야 할지 알 수 없습니다. ThaiFlow가 단어 사이에 자동으로 공백을 넣어 자막 구조가 한눈에 들어옵니다.",
