...
const I18N = {
    ...
    translations: {
        ...
        "ja": {
            ...
            "hero.line2": "外国語をマスター",
            "hero.subtitle": "TikTokのリンクを貼るだけで、AIが一文ずつ自動認識。<br>文単位のリピート再生、発音練習、AI採点 — 英語・日本語・タイ語・フランス語などに対応。",
            "hero.btn.try": "無料で試す",
            "hero.btn.more": "詳しく見る",
            "hero.mock.subtitle": "Nice to meet you!",
            "hero.mock.cn": "はじめまして",
        ...
        "ko": {
            ...
            "hero.subtitle": "TikTok 링크를 붙여넣으면 AI가 문장별로 자동 인식.<br>문장 반복 재생, 발음 연습, AI 채점 — 영어·일본어·태국어·프랑스어 등 지원.",
            "hero.btn.try": "무료로 체험",
