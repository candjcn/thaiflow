...
| 对象 | 奖励 | 触发条件 |
|------|------|---------|
| 邀请人（Referrer） | +100 Credits | 被邀请人首次使用任意 AI 功能 |
...
被邀请人每次**充值积分（Credits）**，邀请人获得充值金额的 **10%** 积分回扣。

示例：
- 被邀请人充值 1000 Credits → 邀请人得 100 Credits
- 被邀请人充值 5000 Credits → 邀请人得 500 Credits

**规则：**
- 返利仅适用于直接充值，不适用于赠送积分或系统奖励
- 返利积分有效期为 30 天；支付功能上线后才启用
