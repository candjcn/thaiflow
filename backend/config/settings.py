...
TIMEOUT_ROMANIZE          = 30
TIMEOUT_TTS_CONTENT       = 30   # TTS 学习内容生成（DeepSeek / Gemini）
TIMEOUT_TTS_SPLIT         = 60   # TTS 分句（DeepSeek）
TIMEOUT_TTS_COVER_PROMPT  = 10   # TTS 封面场景描述生成
TIMEOUT_CF_IMAGE          = 30   # Cloudflare Workers AI 图像生成
